...
"""
In this example, we first generate a random binary classification dataset using make_classification 
function from scikit-learn. We then split the dataset into training and test sets using train_test_split.
 We create an SVM classifier with a linear kernel using SVC function, 
 and train the classifier on the training data using the fit method. 
 Finally, we make predictions on the test data using the predict method and evaluate the performance of the classifier using the accuracy score from accuracy_score function.
